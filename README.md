...
2. 出発地点から半径2km(見つからなければ5km→10kmと自動拡大)以内の犬同伴OK店をもとに、徒歩で巡れる散歩コース(2〜4店、番号つきピン+線)が自動的に地図とカード一覧に表示される
3. 周辺に1店しか無い場合は単体紹介、1店も無い場合はその旨が表示される（いずれも直線距離ベースの「目安」であることを明記）
4. 各店カードの「詳しくは→わんグル」からお店の詳細ページへ移動できる
